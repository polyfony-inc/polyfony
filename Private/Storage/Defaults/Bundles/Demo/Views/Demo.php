<div class="jumbotron" style="padding:45px;">
	<h1>Demo</h1>
	<p>This bundle provides demonstrations of some functionnalities.<br />
	You should delete it for production use as it doesn't provide anything useful.</p>
	<h4>
		Core features
	</h4>
	...
	<a class="btn btn-outline-secondary btn-sm" href="/demo/vendorBootstrap/" role="button"/>Vendor/Bootstrap</a> 
	<a class="btn btn-outline-secondary btn-sm" href="/demo/vendorGoogle/" role="button"/>Vendor/Google</a>
</div>
